...
internal class RoundDecimalCommand : Command<RoundDecimalCommand.Settings>
{
    public override int Execute(CommandContext context, Settings settings)
    {
        ...
        else
        {
            ...
            {
                providedPrecisionLabel = new Text($"{Resources.Apps_Round_Input_Rounding_DecimalPlaces}:", new Style(Color.IndianRed)).LeftJustified();
            }
            else
            {
                providedPrecisionLabel = new Text($"{Resources.Apps_Round_Input_Rounding_DecimalPlaces_NotProvided}:", new Style(Color.IndianRed)).LeftJustified();
            }
